  ...
  return (
    <div className="dialog-overlay">
      <div className="dialog-box success-dialog">
        ...
        <p>Amount: ${amountUSD.toFixed(2)} (KES {amountKES})</p>
...
export default function StripeLikePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://global-work.onrender.com/api/stk', {
        method: 'POST',
        headers: {
        ...
        <Card>
          {paymentStatus === null ? (
            <form onSubmit={handleSubmit}>
              ...
              >
                {isSubmitting ? 'Processing...' : `Pay $${formData.amountUSD || '0.00'}`}
              </button>
            </form>
